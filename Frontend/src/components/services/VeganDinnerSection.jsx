...
const VeganDinnerSection = () => {
  return (
    <section className="service-section">
      ...
      <ul>
        <li>Ubicación: Salón Comunitario Tribal, Calle Principal 456, Ciudad Vibrante</li>
        <li>Horario: Todos los sábados a las 19:00 horas</li>
        <li>Tarifa: Donación sugerida de $20 por persona</li>
      </ul>
      <p>¡Únete a nosotros para una experiencia gastronómica que alimentará tu cuerpo, mente y espíritu mientras te conectas con otros miembros de la tribu en un ambiente acogedor y amoroso!</p>
    </section>
  );
};

export default VeganDinnerSection;
